...
export default function AdminTemplatesPage() {
  return (
    <div className="space-y-6 text-white">
      <div>
        <p className="text-sm uppercase tracking-[0.3em] text-[#D9B86C]">Admin Template Console</p>
      ...
      <div className="rounded-[2rem] border border-white/10 bg-white/5 p-4 text-black">
        <TemplatesPage />
      </div>
    </div>
  );
