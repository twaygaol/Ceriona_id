...
const THEME_STYLES: Record<string, Omit<ThemeStyleSet, "openingQuote" | "heroQuote" | "isThemed">> = {
  ...
  "adat-batak-ulos": {
    sectionBg: "#0E0808",
    sectionBgAlt: "#0E0808",
    cardBg: "rgba(21,16,16,0.88)",
    cardBorder: "1px solid rgba(185,28,28,0.45)",
    cardBorderTop: "2px solid #B91C1C",
    headingColor: "#F7EFE4",
    bodyColor: "rgba(247,239,228,0.8)",
    bodyColorLight: "rgba(247,239,228,0.7)",
    accentColor: "#C9A84C",
    goldColor: "#C9A84C",
    mutedColor: "rgba(247,239,228,0.6)",
    iconBg: "#B91C1C",
    iconColor: "#FFFFFF",
    iconBorder: "1px solid #C9A84C",
    iconRadius: "0",
