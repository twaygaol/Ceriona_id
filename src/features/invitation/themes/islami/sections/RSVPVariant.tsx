    ...
    return (
      <section className="w-full py-20 px-6" style={{ background: colors.surface, fontFamily: fonts.heading }}>
        <div className="max-w-lg mx-auto text-center">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={colors.surface} strokeWidth="2.5">
              <path d="M20 6L9 17L4 12" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </motion.div>
          <h3 className="text-2xl font-bold mb-2" style={{ color: colors.text }}>Jazakumullahu Khairan</h3>
  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto">
        ...
        >
          <p className="text-sm mb-2" style={{ color: colors.accent, fontFamily: fonts.quote, direction: "rtl" }}>
            ...
            <div className="flex gap-3">
              {(["hadir", "tidak hadir", "ragu"] as const).map((opt) => (
                <button
                  ...
                  style={{
                    color: attendance === opt ? colors.surface : colors.text,
                    background: attendance === opt ? colors.primary : colors.background,
                    border: `1.5px solid ${attendance === opt ? colors.primary : `${colors.accent}33`}`,
                    borderRadius: config.layout.borderRadius,
                    fontFamily: fonts.body,
                  }}
                >
