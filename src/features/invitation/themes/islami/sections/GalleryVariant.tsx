        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          {(items || []).map((item, idx) => (
            <motion.div
              ...
              style={{
                border: `3px solid ${colors.accent}66`,
            ...
            >
              ...
              <div
                ...
                style={{
                  backgroundImage: `
                    url("data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3E%3Cpolygon points='15,2 19,11 28,11 21,17 24,27 15,21 6,27 9,17 2,11 11,11' fill='none' stroke='%23D4A84B' stroke-width='0.5' opacity='0.3'/%3E%3C/svg%3E")
                  `,
