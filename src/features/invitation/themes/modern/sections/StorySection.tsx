        ...
        {chapters.length > 0 ? (
          <div className="relative">
            <div
              ...
              style={{ background: `linear-gradient(180deg, transparent, ${colors.secondary}66, transparent)` }}
            />
            ...
            {chapters.map((chapter, idx) => (
              ...
              >
                ...
                <div className={`flex-1 ${idx % 2 === 0 ? "md:text-right md:pr-12" : "md:text-left md:pl-12"}`}>
                  <div className="p-6" style={{ background: colors.surface }}>
                    {chapter.title && (
                      <h3 className="text-lg font-light mb-1" style={{ color: colors.text }}>
                        {chapter.date && (
                          <span className="text-xs block mb-1" style={{ color: colors.secondary, fontFamily: fonts.body }}>
                            {chapter.date}
                          </span>
                        )}
                        {chapter.title}
