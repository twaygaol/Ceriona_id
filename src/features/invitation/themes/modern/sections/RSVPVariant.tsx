    ...
    return (
      <section className="w-full py-20 px-6" style={{ background: colors.surface, fontFamily: fonts.heading }}>
        <div className="max-w-lg mx-auto text-center">
          ...
          <h3 className="text-2xl font-light mb-2" style={{ color: colors.text }}>Terima Kasih!</h3>
  ...
  return (
    ...
    >
      <div className="max-w-lg mx-auto">
        ...
        >
          <div>
            <label className="block text-xs tracking-wider mb-2" style={{ color: colors.text, fontFamily: fonts.body }}>
              Nama Lengkap
            </label>
            <input
              type="text"
            ...
            <div className="flex gap-3">
              {(["hadir", "tidak hadir", "ragu"] as const).map((opt) => (
                <button
                  ...
                  style={{
                    color: attendance === opt ? colors.background : colors.text,
                    background: attendance === opt ? colors.secondary : colors.background,
