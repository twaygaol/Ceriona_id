      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            {/* Ulos rhombus corner markers */}
            <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2 opacity-50"
              style={{ borderColor: colors.accent }}
            />
            <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 opacity-50"
              style={{ borderColor: colors.accent }}
            />
            <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 opacity-50"
              style={{ borderColor: colors.accent }}
            />
            <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2 opacity-50"
              style={{ borderColor: colors.accent }}
            />
            {heroImage && (
            ...
            <p className="text-sm" style={{ color: colors.accent, fontFamily: fonts.quote }}>Anak ni Raja</p>
          ...
          >
            ...
            <p className="text-sm" style={{ color: colors.accent, fontFamily: fonts.quote }}>Boru ni Raja</p>
            <p className="text-xs tracking-widest uppercase mt-2" style={{ color: colors.muted, fontFamily: fonts.body }}>
