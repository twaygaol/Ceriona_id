        ...
        {chapters.length > 0 ? (
          <div className="relative">
            ...
            {chapters.map((chapter, idx) => (
              ...
              >
                {/* Wayang-inspired marker */}
                <div
                  className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-5 h-5 items-center justify-center rounded-full z-10"
                  style={{
                    background: colors.accent,
                    boxShadow: `0 0 0 4px ${colors.background}`,
                  }}
                >
                  <div className="w-2 h-2 rounded-full" style={{ background: colors.surface }} />
                </div>
